...
app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+pymysql://ux8my6vlcea95nrg:4x6JUqLMq5cCSPdgIAFz@bnnaqx2n3e7p5gyo0alk-mysql.services.clever-cloud.com:3306/bnnaqx2n3e7p5gyo0alk'
db = SQLAlchemy(app)
